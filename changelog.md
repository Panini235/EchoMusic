...
1. 【首发】发布 EchoMusic · 畅听第一个正式版本
2. 【界面】重新设计首页、侧边栏、播放页、设置页和常用浮层
3. 【交互】统一播放页按钮触摸区域，修复部分按钮偶发无法点击
4. 【功能】播放队列支持拖拽排序
5. 【插件】保留 MusicFree 插件兼容能力，应用本身不内置音源
6. 【构建】Tag 或手动触发 Workflow 后，通过 GitHub Release 直接提供 APK

---

## MusicFree 上游版本记录

以下内容为上游项目的历史记录，保留用于追溯代码来源。
